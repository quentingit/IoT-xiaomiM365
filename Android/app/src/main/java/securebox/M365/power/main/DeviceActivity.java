...
import com.example.mylibrary.BridgeHandler;
import com.example.mylibrary.BridgeWebView;
import com.example.mylibrary.CallBackFunction;
import com.example.mylibrary.DefaultHandler;
...
import securebox.M365.power.main.Requests.AmpereRequest;
import securebox.M365.power.main.Requests.BatteryLifeRequest;
import securebox.M365.power.main.Requests.DistanceRequest;
import securebox.M365.power.main.Requests.SpeedRequest;
import securebox.M365.power.main.Requests.SuperBatteryRequest;
import securebox.M365.power.main.Requests.SuperMasterRequest;
import securebox.M365.power.main.Requests.SwitchRequests.Cruise.CheckCruise;
import securebox.M365.power.main.Requests.SwitchRequests.Cruise.CruiseOff;
import securebox.M365.power.main.Requests.SwitchRequests.Cruise.CruiseOn;
import securebox.M365.power.main.Requests.SwitchRequests.Light.CheckLight;
import securebox.M365.power.main.Requests.SwitchRequests.Light.LightOff;
import securebox.M365.power.main.Requests.SwitchRequests.Light.LightOn;
import securebox.M365.power.main.Requests.SwitchRequests.Locking.CheckLock;
import securebox.M365.power.main.Requests.SwitchRequests.Locking.LockOff;
import securebox.M365.power.main.Requests.SwitchRequests.Locking.LockOn;
import securebox.M365.power.main.Requests.SwitchRequests.Recovery.CheckRecovery;
import securebox.M365.power.main.Requests.SwitchRequests.Recovery.MediumMode;
import securebox.M365.power.main.Requests.SwitchRequests.Recovery.StrongMode;
import securebox.M365.power.main.Requests.SwitchRequests.Recovery.WeakMode;
import securebox.M365.power.main.Requests.VoltageRequest;
import securebox.M365.power.util.HexString;
import securebox.M365.power.util.LogWriter;
...
public class DeviceActivity extends AppCompatActivity
    ...
    private MenuItem startHandlerButton2;
        ...
        public void run() {
            ...
            if (isConnected() && !runOnce) {
                ...
                if(storagePermission){
                    handler.postDelayed(getLogsRunnable, 1700);
                }
        ...
        public void run() {
            ...
            try {
                ...
                if (isConnected()) {
                    ...
                    Log.d(TAG, "Req 1: " + UUID.fromString(Constants.CHAR_WRITE));
                    Log.d(TAG, "Req 2: " + command);
                    Log.d(TAG, "Req 3: " + HexString.hexToBytes(command));
    ...
    private Runnable runnable = new Runnable() {
        ...
        public void run() {
            ...
            infos.battery= String.valueOf(battery);
            infos.speed = speed;


            webView.callHandler("functionInJs", new Gson().toJson(infos) , new CallBackFunction() {
            ...
            handler2.postDelayed(this, 1700);
        }
    };
    ...
    private void updateUI(byte[] bytes) {
        ...
        if (bytes.length > 10) { //Super handling
            if (requestBit.equals(requestTypes.get(RequestType.SUPERMASTER).getRequestBit())) {
                ...
                speed = requestTypes.get(RequestType.SUPERMASTER).handleResponse(combinedRespose);
                for (SpecialTextView f : textViews) {
                    if (f.getType() == RequestType.SPEED) {
                        runOnUiThread(() -> f.setText(speed));


                        //ICI SE TROUVE LA VITESSE
                        Log.i("--------------------------", speed);
        ...
        Thread t = new Thread() {
            public void run() {
                runOnUiThread(() -> {
                    ...
                    battery = Statistics.getBatteryLife();
    ...
    public void stopHandler() {
        ...
        //menu.findItem(R.id.start_handler_button2).setTitle("Start Handler");
    }
        ...
        if (isConnected()) {
            ...
            connectionDisposable = bleDevice.establishConnection(false)
                    ...
                    .doOnError(throwable -> {
                        ...
                        //handler1.removeCallbacksAndMessages(null);
                        dispose();
                        //menu.findItem(R.id.time2).setTitle("(disconnected)");
                    })
    ...
    private void onConnectionFailure(Throwable throwable) {
        ...
        Toast.makeText(DeviceActivity.this, "Connexion impossible, reessayez", Toast.LENGTH_LONG).show();
    }
    ...
    private void onConnectionReceived(RxBleConnection connection) {
        ...
        //menu.findItem(R.id.time2).setTitle("(connected)");
        handler1.post(process);
        checkFirst();
    }
   ...
   /* @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        else if(id == R.id.start_handler_button2){
            if(!handlerStarted) {
                if (!isConnected()) {
                    doConnect();
                ...
                menu.findItem(R.id.start_handler_button2).setTitle("Stop Handler");
                handlerStarted=true;
            }
            else{
                stopHandler();
